...
<body>
    ...
    ========================== -->
    <div id="content">
      <h2><span class="page-title">Contact Us</span></h2>
      <div class="contact-box p-property clearfix">
      <h3>Contact Information</h3>
      <div class="form-wrap float-right">
	...
	?>
              ...
              <div class="float-left" style="position:absolute; bottom:-25px; right:50px;">
                <p>By sending, you agree to <a href="#">Terms of Use</a> and <a href="#">Privacy Policy</a>.</p>
              </div>
              <div class="float-right">
                <input type="submit" name="contact" value="Contact admin" class="send-to-admin" style="position:absolute; bottom:-35px; left:10px;" />
              </div>
            </form>
            </div>
             <div class="contact-left">
      	<p><span>No 1 Aitoe Idubor Avenue, Off 2nd Ugbor Road, <br />GRA, Benin City, Edo State, Nigeria.</span>
		<br /><span>Email: Admin@virtualestate.com</span>
		<br /><span>Phone: Oscar: 07063564285</span></p>
      		</div>
      </div>
      </div>
      <!-- Start SOCIAL FOOTER
